...
Fabricate.prototype.validateOptions = function(options) {
  var err = null;
  if (typeof options !== 'object' || options instanceof Array) {
    err = 'Options object must be defined';
  }
  if (!options.src) { err = 'src option is required'; }
  if (!options.dest) { err = 'dest option is required'; }
